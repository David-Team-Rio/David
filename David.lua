...
if text == 'حذف الردود' and Manager(msg) and ChCheck(msg) and SourceCh(msg) or text == 'مسح الردود' and Manager(msg) and ChCheck(msg) and SourceCh(msg) or text == 'حذف ردود المدير' and Manager(msg) and ChCheck(msg) and SourceCh(msg) or text == 'مسح ردود المدير' and Manager(msg) and ChCheck(msg) and SourceCh(msg) then
local redod = DevRio:smembers(David..'Rio:Manager:GpRed'..msg.chat_id_)
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
else
...
--     Source David     --
if  text == "ردود المطور" and SecondSudo(msg) and SourceCh(msg) or text == "الردود العام" and SecondSudo(msg) and SourceCh(msg) or text == "↫ ردود العام ↯" and SecondSudo(msg) and SourceCh(msg) or text == "↫ الردود العام ↯" and SecondSudo(msg) and SourceCh(msg) then
...
if text == "حذف ردود المطور" and SecondSudo(msg) and SourceCh(msg) or text == "حذف ردود العام" and SecondSudo(msg) and SourceCh(msg) or text == "مسح ردود المطور" and SecondSudo(msg) and SourceCh(msg) or text == "↫ مسح ردود العام ↯" and SecondSudo(msg) and SourceCh(msg) then
local redod = DevRio:smembers(David.."Rio:Sudo:AllRed")
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
else
